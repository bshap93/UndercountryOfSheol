...
namespace Combat.Shield.Scripts
{
    public class CharacterHandleShield : CharacterAbility
    {
        [MMInspectorGroup("Shield", true, 10)] public Project.Gameplay.Combat.Shields.Shield InitialShield;
        ...
        FPCharacterHandleWeapon _altCharacterHandleWeapon;
        Project.Gameplay.Combat.Shields.Shield _currentShield;


        public Project.Gameplay.Combat.Shields.Shield CurrentShield { get; set; }

        protected override void Start()
        {
            base.Initialization();

            _altCharacterHandleWeapon = GetComponent<FPCharacterHandleWeapon>();
        }
        ...
        public virtual void EquipShield(Project.Gameplay.Combat.Shields.Shield newShield)
        {
            ...
            if (newShield != null)
            {
                ...
                CurrentShield = shieldGO.GetComponent<Project.Gameplay.Combat.Shields.Shield>();
